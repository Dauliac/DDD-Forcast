...
export class CurrentConditionComponent extends HTMLElement {

    constructor(currentCondition, queryClass, tooltipQueryClass) {
        super()
        ...
        this.setAttribute('class', currentConditionClass)
    }

    _render() {
        return `
            <div class="p-2 bd-highlight d-flex flex-column mb-4">
                <div>
                    ${this._renderIcon()}
                </div>
                <div>
                    ${this._currentCondition.condition}</div>
                <div class="d-flex flex-row bd-highlight mb-2 flex-wrap">
                    ${this._renderTemperature()}
                    ${this._renderHumidity()}
                    ${this._renderWindDirection()}
    ...
    _renderIcon() {
        return `
            <img src="${this._currentCondition.iconBig}" alt="${this._currentCondition.condition}">
        `
    }
    ...
    _renderTemperature() {
        ...
        return `
            <div class="p-1 ${this._tooltipQueryClass}" tabindex="0" data-toggle="tooltip" data-placement="top" title="${tooltip}">
                ...
                <span>
                    ${this._currentCondition.temperature}
                </span>
            </div>
        `
    }
    ...
    _renderHumidity() {
        ...
        return `
            <div class="p-1 ${this._tooltipQueryClass}" tabindex="0" data-toggle="tooltip" data-placement="top" title="${tooltip}">
                ...
                <span>
                    ${this._currentCondition.humidity}
                </span>
            </div>
        `
    }
    ...
    _renderWindSpeed() {
        ...
        return `
            <div class="p-1 ${this._tooltipQueryClass}" tabindex="0" data-toggle="tooltip" data-placement="top" title="${tooltip}">
                ...
                <span>
                    ${this._currentCondition.windSpeed}
                </span>
            </div>
        `
    }
    ...
    _renderWindDirection() {
        ...
        return `
            <div class="p-1 ${this._tooltipQueryClass}" tabindex="0" data-toggle="tooltip" data-placement="top" title="${tooltip}">
                ...
                <span>
                    ${this._currentCondition.windDirection}
                </span>
            </div>
        `
    }
...
customElements.define(currentConditionClass, CurrentConditionComponent)
